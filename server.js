...
var htmlFoot = '<footer class="footer" style="position:absolute; bottom:0"><div class="container"><p class="text-muted">Copyright 2016 Saad Kothawala</p></div></footer></div><!-- jQuery Version 1.11.1 --> <script src="https://code.jquery.com/jquery-2.2.0.min.js"></script> <!-- Bootstrap Core JavaScript --> <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.6/js/bootstrap.min.js"></script></body></html>';
